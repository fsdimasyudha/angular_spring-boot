...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dimasyudha.dimasyudha.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dimasyudha.dimasyudha.security.DomainUserDetailsService", "createSpringSecurityUser");
